...
server.get('/explore/:country', function(req, res){
	var COUNTRY = req.params.country;
		...
		request('http://developer.echonest.com/api/v4/artist/search?api_key=' + process.env.EN_AK + '&format=json&artist_location=country:' + COUNTRY + '&bucket=artist_location&bucket=biographies&bucket=blogs&bucket=video&bucket=urls&bucket=years_active; ', function(error, response, body){
